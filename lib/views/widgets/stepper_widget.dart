...
/// A material step used in [StepperIcon]. The step can have a title and subtitle,
...
@immutable
class StepIcon {
  /// Creates a step for a [StepperIcon].
  ///
  ...
  /// The icon of the step that typically describes it.
  final IconData? icon;
}
...
///
/// {@tool dartpad}
/// An example the shows how to use the [StepperIcon], and the [StepperIcon] UI
/// appearance.
///
...
class _StepperIconState extends State<StepperIcon> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(StepperIcon oldWidget) {
          ...
          child:
              SizedBox(
                ...
                child: Center(
                  ...
                  children: [
                    _buildIcon(i), _buildHeaderText(i),
                  ],
                  ),
                ),
              ),
  ...
  Widget build(BuildContext context) {
    ...
    assert(() {
      if (context.findAncestorWidgetOfExactType<StepperIcon>() != null)
        throw FlutterError(
