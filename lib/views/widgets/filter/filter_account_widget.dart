...
import 'package:venturiautospurghi/cubit/filter_accounts/account_filter_cubit.dart';
...
class AccountsFilterWidget extends FilterWidget {
  ...
  Widget filterBox(BuildContext context) {
    ...
    return new Form(
        key: context.read<AccountFilterCubit>().formKey,
        child: Column(
                        ...
                        child: Row(
                          children: <Widget>[
                            ...
                            Expanded(
                                child: TextFormField(
                                  cursorColor: white,
                                  controller: context.read<AccountFilterCubit>().titleController,
                                  ...
                                  onSaved: (value) => context.read<AccountFilterCubit>().state.filters["name-surname"]!.fieldValue = value??"",
                                )),
                          ],
                        )): Container(),
                    Padding(
                        ...
                        child: Row(
                          children: <Widget>[
                            ...
                            Expanded(
                                child: TextFormField(
                                  controller: context.read<AccountFilterCubit>().emailController,
                                  cursorColor: white,
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    hintStyle: subtitle.copyWith(fontSize: labelSize),
                                    border: InputBorder.none,),
                                  onSaved: (value) => context.read<AccountFilterCubit>().state.filters["email"]!.fieldValue = value??"",
                                )),
                          ],
                        )),
                    Padding(
                        ...
                        child: Row(
                          children: <Widget>[
                            ...
                            Expanded(
                                child: TextFormField(
                                  controller: context.read<AccountFilterCubit>().phoneController,
                                  cursorColor: white,
                                  keyboardType: TextInputType.phone,
                                  style: TextStyle(color: white, fontSize: labelSize),
                                  decoration: InputDecoration(
                                    ...
                                    hintStyle: subtitle.copyWith(fontSize: labelSize),
                                    border: InputBorder.none,),
                                  onSaved: (value) => context.read<AccountFilterCubit>().state.filters["phone"]!.fieldValue = value??"",
                                )),
                          ],
                        )),
                    Padding(
                          ...
                          children: <Widget>[
                            ...
                            Expanded(
                                child: TextFormField(
                                  keyboardType: TextInputType.text,
                                  cursorColor: white,
                                  controller: context.read<AccountFilterCubit>().codicefiscaleController,
                                  style: TextStyle(color: white, fontSize: labelSize),
                                  decoration: InputDecoration(
                                    isDense: true,
                                    contentPadding: EdgeInsets.symmetric(vertical: 5),
                                  ...
                                  onSaved: (value) => context.read<AccountFilterCubit>().state.filters["codFiscale"]!.fieldValue = value??"",
                                )),
                          ]),
                    )
                  ],
  ...
  void onSearchFieldTextChanged(BuildContext context, text){
    context.read<AccountFilterCubit>().onSearchFieldTextChanged(text);
  }

  @override
  void clearFilters(BuildContext context) {
    context.read<AccountFilterCubit>().clearFilters(
        PlatformUtils.isMobile?context.read<AccountFilterCubit>().state.filters:
    context.read<WebCubit>().state.filters);
  }

  @override
  void applyFilters(BuildContext context){
    context.read<AccountFilterCubit>().notifyFiltersChanged(PlatformUtils.isMobile?context.read<AccountFilterCubit>().state.filters:
    context.read<WebCubit>().state.filters, true);
  }

  @override
  TextEditingController titleController(BuildContext context) => context.read<AccountFilterCubit>().titleController;


  @override
  Widget build(BuildContext context) {
    return new BlocProvider(
      create: (_) => AccountFilterCubit(callbackSearchFieldChanged, callbackFiltersChanged, PlatformUtils.isMobile? {}
              :context.read<WebCubit>().state.filters),
      child: BlocBuilder<AccountFilterCubit, AccountsFilterState>(
          buildWhen: (previous, current) => previous != current,
          builder: (context, state) {
            super.showFiltersBox = context.read<AccountFilterCubit>().showFiltersBox;
