...
class CheckboxTriState extends StatefulWidget {
...
class _CheckboxState extends State<CheckboxTriState> with TickerProviderStateMixin, ToggleableStateMixin {
  ...
  @override
  void didUpdateWidget(CheckboxTriState oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    final Color effectiveSuperColor = widget.superColor
        ?? themeData.checkboxTheme.checkColor?.resolve(states)
        ?? const Color(0xFFFFFFFF);
    ...
    return Semantics(
      ...
      child: buildToggleable(
        ...
        painter: _painter
          ...
          ..superColor = effectiveSuperColor
          ..value = value
...
class _CheckboxPainter extends ToggleablePainter {
  ...
  Color get superColor => _superColor!;
  ...
  set superColor(Color value) {
    if (_superColor == value) {
      return;
    }
    _superColor = value;
    notifyListeners();
  ...
  Paint _createStrokePaint(bool superFlag) {
    return Paint()
      ..color = superFlag?superColor:checkColor
